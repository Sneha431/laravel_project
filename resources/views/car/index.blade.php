...
<x-app-layout bodyClass="page-my-cars" title="Show Car Page">
    <main>
        <div>
            <div class="container">
                                ...
                                @forelse ($cars as $car)
                                    <tr>
                                        <td>
                                            @php 
                                               ...
                                               @endphp
                                                                 ...
                                                                 <img   src="{{ $img ? Str::startsWith($img, ['http://', 'https://']) ? $img : asset('uploads/cars/' . $img) : asset('uploads/cars/no-image.png' )}}"  alt="Car Image"
                                        ...
                                        <td class="">
                                            ...
                                            <a href="{{route("car.show", $car)}}" class="btn btn-edit inline-flex items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                                    stroke="currentColor" style="width: 12px; margin-right: 5px">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
