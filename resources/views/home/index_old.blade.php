...
@section("content")
                ...
                <!--/ Find a car form -->
                    <x-search-form  action="/search"/>
                                ...
                                <a href="#">Link 4</a>
                                @endsection
                                {{-- @sectionMissing("extralinks")
                                @include("layouts.partials.footer")
                                @endif

                              <input type="checkbox" name="" id="" @checked(false)> 
                                <input type="checkbox" name="" id="" @disabled(true)>
                                <input type="text" name="" id="" @readonly(false)>
                                <input type="text" name="" id="" @required(false)>

                        <select>
                            @foreach (["2000","2004","2006"] as $year)
                                <option value="{{$year}}" @selected($year=="2004")>{{$year}}</option>
                            @endforeach
                        </select>
                        --}}
                        {{-- <x-card/>
                        ...
                        {{-- <x-card> --}}
                            {{-- <x-slot name="title2">
                                Named slot card title 1
                            </x-slot> --}}
                        {{-- <x-slot name="title">
                            Named slot card title 1
                        </x-slot> --}}
                            {{-- Named slot card content 1 --}}
                            {{-- <x-slot name="footer">
                                Named slot card footer 1
                            </x-slot>
                        ...
                        <x-card> --}}
                            ...
                            {{-- <x-slot:title2>
                                Named slot card title 2
                            </x-slot:title2> --}}
                            {{-- <x-slot:title>
                                Named slot card title 2
                            </x-slot:title>
                            Named slot card content 2
                            <x-slot:footer>
                                Named slot card footer 2
                            </x-slot:footer>
                        </x-card>
                        <x-search-form/> --}}
                        {{-- <x-card>
                            Default slot card content 1
                        </x-card>--}}
                        {{-- <x-card color="red" bg-color="green"> --}}
                            @php
    $size = "34px";
    $fontWeight = "600"
                            @endphp

                            <x-card color="red" bgColor="blue" :fontSize="$size" :$fontWeight lang="en" 
                            class="class-rounded">
                        ...
                        Default slot card content 3
                        <x-slot:footer>
                            Named slot card footer 2
                        </x-slot:footer>
                        </x-card> 
                        <x-test-component class="card-test">
                            Test component
                        </x-test-component>
@endsection